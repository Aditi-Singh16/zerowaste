...
class _ShoppingCartState extends State<ShoppingCart> {
  ...
  Future<void> openCheckout() async {
    var options = {
      ...
      "amount":
      (walletm)  ? (amountw * 100).toString() : plant==true? ((megatotal+5) * 100).toString():(megatotal * 100).toString(),
      "name": "Sample App",
                    ...
                    children: [
                      ...
                      (walletm)
                        ...
                        children: [
                          ...
                          Container(
                            padding: EdgeInsets.only(right: 40),
                            child: plant==true?Text((megatotal+5).toString(),
                                style: TextStyle(
                                  color: Colors.black,
                                  fontWeight: FontWeight.bold,
                                  fontSize: MediaQuery.of(context)
                      ...
                      Container(
                          ...
                          child: ElevatedButton(
                            ...
                            child: plant==true?Text('Proceed to Checkout ' +
                                '\u{20B9}' +
                                (megatotal+5).toString()+
                                " (" +
                                quant.toString() +
                                " Item) "):Text('Proceed to Checkout ' +
                                '\u{20B9}' +
                                (megatotal).toString() +
                                " (" +
                                quant.toString() +
